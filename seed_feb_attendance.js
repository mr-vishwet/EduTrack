...
const END_DATE   = '2026-02-28'; // end of Feb
...
async function seedAttendance() {
  ...
  for (const cls of CLASSES) {
    ...
    console.log(`✅ Class ${cls.classId} (${studentIds.length} students) — ${batchCount > 0 ? schoolDays.length : 'batched'} records`);
  }
